...
#3 : this is thread safe but we lock and unlokc mutext every print operation. 
    this wasting the computer cycles. and we dont wanna spend computing performance to wast
#4 : this line resolve 3. problem elagantly.
*/
...
public:
    ...
    void shared_print(string id, int value)
    {
        ...
        std::call_once(_flag, [&]() { _f.open("log.txt"); }); /*#4*/
